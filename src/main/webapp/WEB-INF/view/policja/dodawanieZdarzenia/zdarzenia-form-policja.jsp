...
<div class="container">
    ...
    <form:form action="zapiszZdarzenie" role="form" data-toggle="validator" modelAttribute="zdarzenie" cssClass="form-horizontal" method="POST">
        <div class="form-group">
            ...
            <div class="col-xs-10">
                <form:input path="IdKierowcy" id="kieroInput"  cssClass="form-control" type="number" required="required"
                            oninvalid="setCustomValidity('Wypełnij to pole! (0 - kierowca nieznany)')"
        ...
        <div class="form-group">
            ...
            <div class="col-xs-10">
                <form:select path="TypZdarzenia" id="typInput" cssClass="form-control">
                    ...
                    <form:option value="Zgłoszenie kradzieży pojazdu">Zgłoszenie kradzieży</form:option>
                    <form:option value="Odzyskanie pojazdu">Zgłoszenie kradzieży</form:option>
